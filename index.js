...
function calculateAge() {
  ...
  const labels = [document.getElementById("label-day"), document.getElementById("label-month"), document.getElementById("label-year")];
  const lightRed= getComputedStyle(document.documentElement).getPropertyValue('--color-light-red');
  ...
  for (let i = 0; i < inputs.length; i++) {
    if (inputs[i] === "" || inputs[i] === null) {
      ...
      document.getElementById(labels[i].htmlFor).style.border = '1px solid #ff8c8c';
